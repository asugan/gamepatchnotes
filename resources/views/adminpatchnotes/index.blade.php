...
@section('content')
    ...
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead">
            ...
            <a href="{{ route('patchnotes.create') }}" class="btn btn-primary btn-sm float-right">Add post</a>
        </div>
        ...
        <table class="table table-bordered">
            ...
            @foreach ($posts as $key => $post)
                <tr>
                    ...
                    <td>
                        {!! Form::open(['method' => 'DELETE', 'route' => ['patchnotes.destroy', $post->slug], 'style' => 'display:inline']) !!}
