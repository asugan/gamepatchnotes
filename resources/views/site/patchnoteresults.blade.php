...
@section('title', 'Latest Patch Notes - Search Patchnote Results')
...
@section('og.title', 'Latest Patch Notes - Search Patchnote Results')
...
@section('content')
    ...
    <section class="allpatchnotes">
        <div class="container mx-auto pt-4 pb-4">
            <h1 class="text-center text-4xl font-bold htext pb-8">Total Results in DB : ({{ count($results) }})</h1>
