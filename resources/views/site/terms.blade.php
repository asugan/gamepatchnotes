...
@section('content')
    <div class="container text-white py-8">
            ...
            <nav class="bctext font-bold" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex" itemscope itemtype="https://schema.org/BreadcrumbList">
                    ...
                    <li class="flex items-center" itemprop="itemListElement" itemscope
                        ...
                        <a class="hover:underline" itemprop="item" href="{{ route('terms') }}"> <span itemprop="name">Terms
                                and Conditions
                            </span></a>
        ...
        <h2 class="text-2xl py-4">Terms and Conditions</h2>
        <p>Welcome to Latest Patch Notes!

            These terms and conditions outline the rules and regulations for the use of Latest Patch Notes's Website,
            located
            at https://latestpatchnotes.com/.

            By accessing this website we assume you accept these terms and conditions. Do not continue to use Free Games
            Codes if you do not agree to take all of the terms and conditions stated on this page.
        ...
        <h2 class="text-2xl py-4">Cookies</h2>
        <p>We employ the use of cookies. By accessing Latest Patch Notes, you agreed to use cookies in agreement with the
            Free
            Games Codes's Privacy Policy.
        ...
        <h2 class="text-2xl py-4">License</h2>

        <p>Unless otherwise stated, Latest Patch Notes and/or its licensors own the intellectual property rights for all
            material on Latest Patch Notes. All intellectual property rights are reserved. You may access this from Free
            Games
            Codes for your own personal use subjected to restrictions set in these terms and conditions.

            You must not:


            Republish material from Latest Patch Notes

            Sell, rent or sub-license material from Latest Patch Notes

            Reproduce, duplicate or copy material from Latest Patch Notes

            Redistribute content from Latest Patch Notes
            Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. Latest Patch Notes does not filter, edit, publish or review Comments prior to their
            presence
            on the website. Comments do not reflect the views and opinions of Latest Patch Notes,its agents and/or
            affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted
            by applicable laws, Latest Patch Notes shall not be liable for the Comments or for any liability, damages or
            expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on
            this website.

            Latest Patch Notes reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            unlawful activity.
            You hereby grant Latest Patch Notes a non-exclusive license to use, reproduce, edit and authorize others to use,
            reproduce and edit any of your Comments in any and all forms, formats or media.</p>

        <h2 class="text-2xl py-4">Hyperlinking to our Content</h2>
        ...
        <p>The following organizations may link to our Website without prior written approval:
            ...
            records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Free
            Games Codes; and (d) the link is in the context of general resource information.
            ...
            you must inform us by sending an e-mail to Latest Patch Notes. Please include your name, your organization name,
            ...
            No use of Latest Patch Notes's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>

        <h2 class="text-2xl py-4">iFrames</h2>
        ...
        <h2 class="text-2xl py-4">Content Liability</h2>
        ...
        <h2 class="text-2xl py-4">Your Privacy</h2>

        <p>Please read Privacy Policy</p>

        <h2 class="text-2xl py-4">Reservation of Rights</h2>
        ...
        <h2 class="text-2xl py-4">Removal of links from our website</h2>
        ...
        <h2 class="text-2xl py-4">Disclaimer</h2>
